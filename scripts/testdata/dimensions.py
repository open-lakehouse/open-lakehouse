...
ITEMS_BY_BRAND = {
    1: [  # Burger Republic
        ...
        ("Cheese Burger", 13.99, 2),
        ("Bacon Burger", 15.99, 2),
        ("Veggie Burger", 11.99, 2),
        ("Fries", 4.99, 3),
        ("Onion Rings", 5.99, 3),
        ("Milkshake", 6.99, 5),
        ("Soda", 2.99, 5),
    ...
    2: [  # Wok This Way
        ("Kung Pao Chicken", 14.99, 10),
        ("Beef Broccoli", 15.99, 10),
        ("Fried Rice", 10.99, 10),
        ("Lo Mein", 11.99, 10),
        ("Spring Rolls", 6.99, 1),
        ("Egg Drop Soup", 4.99, 7),
        ("Orange Chicken", 13.99, 10),
        ("General Tso", 14.99, 10),
    ],
    3: [  # Pizza Planet
        ("Margherita Pizza", 16.99, 9),
        ("Pepperoni Pizza", 18.99, 9),
        ("Supreme Pizza", 21.99, 9),
        ("Veggie Pizza", 17.99, 9),
        ("Garlic Bread", 5.99, 1),
        ("Caesar Salad", 8.99, 6),
        ("Tiramisu", 7.99, 4),
        ("Cannoli", 5.99, 4),
    ...
    4: [  # Taco Tornado
        ("Street Tacos", 11.99, 2),
        ("Burrito Bowl", 13.99, 2),
        ("Quesadilla", 10.99, 2),
        ("Nachos", 9.99, 1),
        ("Churros", 5.99, 4),
        ("Horchata", 3.99, 5),
    ...
    5: [  # Sushi Express
        ...
        ("Salmon Sashimi", 16.99, 10),
        ("Spicy Tuna Roll", 14.99, 10),
    ...
    6: [  # Wing Commander
        ("Buffalo Wings", 13.99, 2),
        ("BBQ Wings", 13.99, 2),
        ("Garlic Parmesan Wings", 14.99, 2),
        ("Boneless Wings", 12.99, 2),
        ("Celery & Carrots", 3.99, 3),
        ("Ranch Dip", 1.99, 3),
        ("Cheese Fries", 6.99, 3),
        ("Coleslaw", 3.99, 6),
    ],
    7: [  # Curry House
        ("Chicken Tikka Masala", 16.99, 2),
        ("Lamb Vindaloo", 18.99, 2),
        ("Palak Paneer", 14.99, 2),
        ("Biryani", 15.99, 2),
        ("Samosas", 6.99, 1),
        ("Naan Bread", 3.99, 3),
        ("Mango Lassi", 4.99, 5),
    ...
    8: [  # Mediterranean Grill
        ("Chicken Shawarma", 14.99, 2),
        ("Lamb Gyro", 15.99, 2),
        ("Falafel Plate", 12.99, 2),
        ("Hummus Plate", 9.99, 1),
        ("Tabbouleh", 6.99, 6),
        ("Baklava", 5.99, 4),
        ("Pita Bread", 2.99, 3),
    ...
    9: [  # Pho Real
        ...
        ("Banh Mi", 10.99, 8),
        ("Spring Rolls", 6.99, 1),
        ("Vietnamese Coffee", 4.99, 5),
        ("Vermicelli Bowl", 13.99, 2),
        ("Egg Rolls", 5.99, 1),
    ],
    10: [  # BBQ Pitmaster
        ("Brisket Plate", 19.99, 2),
        ("Pulled Pork", 15.99, 2),
        ("Ribs Half Rack", 22.99, 2),
        ("Smoked Chicken", 14.99, 2),
        ("Mac & Cheese", 5.99, 3),
        ("Baked Beans", 4.99, 3),
        ("Cornbread", 3.99, 3),
        ("Banana Pudding", 5.99, 4),
    ],
    11: [  # Salad Station
        ("Greek Salad", 11.99, 6),
        ("Cobb Salad", 13.99, 6),
        ...
        ("Asian Salad", 12.99, 6),
        ("Soup of the Day", 5.99, 7),
        ("Fresh Juice", 5.99, 5),
        ("Protein Add-on", 4.99, 2),
        ("Dressing", 0.99, 3),
    ],
    12: [  # Noodle Nirvana
        ("Pad Thai", 14.99, 10),
        ("Singapore Noodles", 13.99, 10),
        ("Dan Dan Noodles", 12.99, 10),
        ("Udon Stir Fry", 14.99, 10),
        ("Crab Rangoon", 7.99, 1),
        ("Pot Stickers", 6.99, 1),
        ("Bubble Tea", 5.99, 5),
        ("Mochi", 4.99, 4),
    ...
    13: [  # Fried Chicken Co
        ("2pc Chicken", 9.99, 2),
        ("3pc Chicken", 12.99, 2),
        ("Chicken Sandwich", 10.99, 8),
        ("Tenders", 11.99, 2),
        ("Mashed Potatoes", 3.99, 3),
        ("Biscuit", 2.49, 3),
        ("Honey Butter", 0.99, 3),
        ("Sweet Tea", 2.99, 5),
    ],
    14: [  # Greek Gods
        ("Souvlaki Plate", 15.99, 2),
        ("Moussaka", 16.99, 2),
        ("Gyro Wrap", 12.99, 8),
        ("Spanakopita", 8.99, 1),
        ("Greek Salad", 9.99, 6),
    ...
    15: [  # Thai Street
        ("Pad Thai", 14.99, 10),
        ("Green Curry", 15.99, 2),
        ("Massaman Curry", 16.99, 2),
        ("Tom Yum Soup", 8.99, 7),
        ("Mango Sticky Rice", 7.99, 4),
        ("Thai Iced Tea", 4.99, 5),
        ("Satay Skewers", 9.99, 1),
        ("Papaya Salad", 8.99, 6),
    ],
    16: [  # Breakfast Club
        ("Pancakes", 10.99, 2),
        ("Eggs Benedict", 14.99, 2),
        ("Avocado Toast", 11.99, 2),
        ("Breakfast Burrito", 12.99, 2),
        ("Hash Browns", 4.99, 3),
        ("Fresh Fruit", 5.99, 3),
        ("Orange Juice", 3.99, 5),
        ("Coffee", 2.99, 5),
    ...
    17: [  # Smoothie Bowl
        ("Acai Bowl", 12.99, 2),
        ("Pitaya Bowl", 12.99, 2),
        ("Green Smoothie", 8.99, 5),
        ("Protein Shake", 9.99, 5),
        ("Granola Add-on", 2.99, 3),
        ("Nut Butter", 1.99, 3),
        ("Fresh Berries", 3.99, 3),
        ("Coconut Water", 4.99, 5),
    ],
    18: [  # Ramen House
        ("Tonkotsu Ramen", 15.99, 7),
        ("Miso Ramen", 14.99, 7),
        ("Shoyu Ramen", 14.99, 7),
        ("Spicy Ramen", 15.99, 7),
        ("Gyoza", 7.99, 1),
    ...
    19: [  # Soul Food Kitchen
        ("Fried Catfish", 16.99, 2),
        ("Smothered Chicken", 15.99, 2),
        ("Oxtails", 21.99, 2),
        ("Meatloaf", 14.99, 2),
        ("Collard Greens", 4.99, 3),
        ("Candied Yams", 4.99, 3),
        ("Cornbread", 2.99, 3),
        ("Sweet Potato Pie", 5.99, 4),
    ],
    20: [  # Vegan Vibes
        ("Buddha Bowl", 14.99, 2),
        ("Vegan Burger", 13.99, 2),
        ("Cauliflower Tacos", 12.99, 2),
        ("Jackfruit Sandwich", 13.99, 8),
        ("Kale Chips", 5.99, 1),
        ("Coconut Yogurt", 6.99, 4),
        ("Kombucha", 4.99, 5),
        ("Date Balls", 5.99, 4),
    ],
}
