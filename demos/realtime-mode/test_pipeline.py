...
TEST_BLOCKS = [
    (1_000_001, "0xabc001", "0xparent001",
     "0x742d35Cc6634C0532925a3b844Bc9e7595f8dB01",
     8_000_000, 15_000_000, 150, 1710327045,
     "1000000000000000000", "Normal block data"),
    (1_000_002, "0xabc002", "0xparent002",
     "0x742d35Cc6634C0532925a3b844Bc9e7595f8dB02",
     14_550_000, 15_000_000, 180, 1710327046,
     "2000000000000000000", "High gas block"),
    (1_000_003, "0xabc003", "0xparent003",
     "0x742d35Cc6634C0532925a3b844Bc9e7595f8dB03",
     0, 15_000_000, 0, 1710327047, "0", "Empty"),
    (1_000_004, "0xabc004", "0xparent004",
     "0x742d35Cc6634C0532925a3b844Bc9e7595f8dB04",
     5_000_000, 15_000_000, 100, 1710327048,
     "500000000000000000", "Contact: user@example.com for support"),
    (1_000_005, "0xabc005", "0xparent005",
     "0x742d35Cc6634C0532925a3b844Bc9e7595f8dB05",
     7_500_000, 15_000_000, 200, 1710327049,
     "3000000000000000000", "Another normal block"),
    (1_000_006, "0xabc006", "0xparent006",
     "0x0000000000000000000000000000000000000000",
     6_000_000, 15_000_000, 120, 1710327050,
     "800000000000000000", "Block with zero miner"),
    (1_000_007, "0xabc007", "0xparent007",
     "0x742d35Cc6634C0532925a3b844Bc9e7595f8dB07",
     12_000_000, 15_000_000, 600, 1710327051,
     "5000000000000000000", "High transaction count block"),
    (1_000_008, "0xabc008", "0xparent008",
     "0x742d35Cc6634C0532925a3b844Bc9e7595f8dB08",
     4_000_000, 15_000_000, 80, 1710327052,
     "200000000000000000", "SSN leaked: 123-45-6789"),
    (1_000_009, "0xabc009", "0xparent009",
     "0x742d35Cc6634C0532925a3b844Bc9e7595f8dB09",
     3_500_000, 15_000_000, 90, 1710327053,
     "150000000000000000", "Card: 4111-1111-1111-1111"),
    (1_000_010, "0xabc010", "0xparent010",
     "0x742d35Cc6634C0532925a3b844Bc9e7595f8dB10",
     5_500_000, 15_000_000, 110, 1710327054,
     "400000000000000000", f"Key: {TEST_AWS_KEY}"),
    (1_000_011, "0xabc011", "0xparent011",
     "0x742d35Cc6634C0532925a3b844Bc9e7595f8dB11",
     14_800_000, 15_000_000, 300, 1710327055,
     "6000000000000000000", "Alert admin@company.org immediately"),
    (1_000_012, "0xabc012", "0xparent012",
     "0x742d35Cc6634C0532925a3b844Bc9e7595f8dB12",
     4_500_000, 15_000_000, 95, 1710327056,
     "250000000000000000", f"Token: {TEST_JWT}"),
]
...
def detect_sensitive_col(name: str):
    return (
        f.when(f.col(name).rlike(r"AKIA[0-9A-Z]{16}"),
        ...
        .when(f.col(name).rlike(r"0x[a-fA-F0-9]{64}"),
              f.lit("CREDENTIAL_PRIVATE_KEY"))
        .when(f.col(name).rlike(r"\b\d{3}-\d{2}-\d{4}\b"),
              f.lit("PII_SSN"))
        .when(f.col(name).rlike(r"\b(\d{4}[-\s]?){3}\d{4}\b"),
...
def run_transform_tests(spark: SparkSession) -> int:
    ...
    for row in rows:
        ...
        ok = (
            ...
            and actual_reasons == sorted(expected_reasons)
        )
